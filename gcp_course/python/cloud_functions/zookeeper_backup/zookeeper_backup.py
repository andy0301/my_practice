...
def backup_zookeeper_node(zk_client, zk_node):
    ...
    # try:
    #    load above backup json file to GCS
    # except Exception as e:
    #     logging.error("Upload backup: {} to gs://{} failed.".format(backup_file_name, bucket_name))
